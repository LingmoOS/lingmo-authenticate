 ...
 *
 * This section contains code for working with the <link linkend="gdbus-interface-com-deepin-daemon-Authenticate-Session.top_of_page">com.lingmo.daemon.Authenticate.Session</link> D-Bus interface in C.
 */
 ...
 *
 * Gets a machine-readable description of the <link linkend="gdbus-interface-com-deepin-daemon-Authenticate-Session.top_of_page">com.lingmo.daemon.Authenticate.Session</link> D-Bus interface.
 *
 ...
 *
 * Abstract interface type for the D-Bus interface <link linkend="gdbus-interface-com-deepin-daemon-Authenticate-Session.top_of_page">com.lingmo.daemon.Authenticate.Session</link>.
 */
 ...
 *
 * Virtual table for the D-Bus interface <link linkend="gdbus-interface-com-deepin-daemon-Authenticate-Session.top_of_page">com.lingmo.daemon.Authenticate.Session</link>.
 */
 ...
 * @user_data: User data to pass to @callback.
 *
 * Asynchronously creates a proxy for the D-Bus interface <link linkend="gdbus-interface-com-deepin-daemon-Authenticate-Session.top_of_page">com.lingmo.daemon.Authenticate.Session</link>. See g_dbus_proxy_new() for more details.
 *
 * When the operation is finished, @callback will be invoked in the <link linkend="g-main-context-push-thread-default">thread-default main loop</link> of the thread you are calling this method from.
...
com_deepin_daemon_authenticate_session_proxy_new (
    ...
    gpointer             user_data)
{
  g_async_initable_new_async (TYPE_COM_DEEPIN_DAEMON_AUTHENTICATE_SESSION_PROXY, G_PRIORITY_DEFAULT, cancellable, callback, user_data, "g-flags", flags, "g-name", name, "g-connection", connection, "g-object-path", object_path, "g-interface-name", "com.lingmo.daemon.Authenticate.Session", NULL);
}
 ...
 * @error: Return location for error or %NULL
 *
 * Synchronously creates a proxy for the D-Bus interface <link linkend="gdbus-interface-com-deepin-daemon-Authenticate-Session.top_of_page">com.lingmo.daemon.Authenticate.Session</link>. See g_dbus_proxy_new_sync() for more details.
 *
...
{
  GInitable *ret;
  ret = g_initable_new (TYPE_COM_DEEPIN_DAEMON_AUTHENTICATE_SESSION_PROXY, cancellable, error, "g-flags", flags, "g-name", name, "g-connection", connection, "g-object-path", object_path, "g-interface-name", "com.lingmo.daemon.Authenticate.Session", NULL);
  if (ret != NULL)
    return COM_DEEPIN_DAEMON_AUTHENTICATE_SESSION (ret);
  else
    return NULL;
...
com_deepin_daemon_authenticate_session_proxy_new_for_bus (
    ...
    gpointer             user_data)
{
  g_async_initable_new_async (TYPE_COM_DEEPIN_DAEMON_AUTHENTICATE_SESSION_PROXY, G_PRIORITY_DEFAULT, cancellable, callback, user_data, "g-flags", flags, "g-name", name, "g-bus-type", bus_type, "g-object-path", object_path, "g-interface-name", "com.lingmo.daemon.Authenticate.Session", NULL);
}
...
{
  GInitable *ret;
  ret = g_initable_new (TYPE_COM_DEEPIN_DAEMON_AUTHENTICATE_SESSION_PROXY, cancellable, error, "g-flags", flags, "g-name", name, "g-bus-type", bus_type, "g-object-path", object_path, "g-interface-name", "com.lingmo.daemon.Authenticate.Session", NULL);
  if (ret != NULL)
    return COM_DEEPIN_DAEMON_AUTHENTICATE_SESSION (ret);
  else
    return NULL;
  ...
  for (n = 0; _com_deepin_daemon_authenticate_session_interface_info.parent_struct.properties[n] != NULL; n++)
    {
      ...
      if (info->flags & G_DBUS_PROPERTY_INFO_FLAGS_READABLE)
        {
          GVariant *value;
          value = _com_deepin_daemon_authenticate_session_skeleton_handle_get_property (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)), NULL, g_dbus_interface_skeleton_get_object_path (G_DBUS_INTERFACE_SKELETON (skeleton)), "com.lingmo.daemon.Authenticate.Session", info->name, NULL, skeleton);
          if (value != NULL)
            {
 ...
 *
 * Creates a skeleton object for the D-Bus interface <link linkend="gdbus-interface-com-deepin-daemon-Authenticate-Session.top_of_page">com.lingmo.daemon.Authenticate.Session</link>.
 *
