...
/* ------------------------------------------------------------------------
 * Code for interface com.lingmo.daemon.Authenticate
 * ------------------------------------------------------------------------
 */
  ...
  gpointer      user_data)
{
  ...
  if (!_ret)
    {
      g_warning ("Error setting property '%s' on interface com.lingmo.daemon.Authenticate: %s (%s, %d)",
  ...
  for (l = connections; l != NULL; l = l->next)
    {
      ...
      g_dbus_connection_emit_signal (connection,
        NULL, g_dbus_interface_skeleton_get_object_path (G_DBUS_INTERFACE_SKELETON (skeleton)), "com.lingmo.daemon.Authenticate", "LimitUpdated",
        signal_variant, NULL);
    }
